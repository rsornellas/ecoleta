...
exports.default = util_1.createRule({
    ...
    create(context, [{ allowConstantLoopConditions }]) {
        ...
        function checkNode(node) {
            ...
            if (tsutils_1.unionTypeParts(type).some(part => util_1.isTypeFlagSet(part, ts.TypeFlags.Any |
        ...
        function checkNodeForNullish(node) {
            ...
            if (util_1.isTypeFlagSet(type, ts.TypeFlags.Any | ts.TypeFlags.Unknown)) {
                return;
            }
            const messageId = util_1.isTypeFlagSet(type, ts.TypeFlags.Never)
                ? 'never'
        ...
        function checkIfBinaryExpressionIsNecessaryConditional(node) {
            ...
            if (tsutils_1.isStrictCompilerOptionEnabled(compilerOptions, 'strictNullChecks')) {
                ...
                const NULLISH = node.operator === '==' || node.operator === '!='
                    ? NULL | UNDEFINED
                    : NULL;
                if ((leftType.flags === UNDEFINED &&
                    !util_1.isTypeFlagSet(rightType, UNDEFINED, true)) ||
                    (rightType.flags === UNDEFINED &&
                        !util_1.isTypeFlagSet(leftType, UNDEFINED, true)) ||
                    (leftType.flags === NULL &&
                        !util_1.isTypeFlagSet(rightType, NULLISH, true)) ||
                    (rightType.flags === NULL && !util_1.isTypeFlagSet(leftType, NULLISH, true))) {
        ...
        function isOptionableExpression(node) {
            ...
            const isOwnNullable = util_1.isMemberOrOptionalMemberExpression(node)
                ...
                : true;
            return (util_1.isTypeFlagSet(type, ts.TypeFlags.Any) ||
                util_1.isTypeFlagSet(type, ts.TypeFlags.Unknown) ||
