...
exports.isTypedFunctionExpression = exports.doesImmediatelyReturnFunctionExpression = exports.checkFunctionReturnType = exports.checkFunctionExpressionReturnType = exports.ancestorHasReturnType = void 0;
 ...
 */
function isValidFunctionReturnType(node, options, isParentCheck = false) {
    if (!isParentCheck &&
 ...
 * the given options.
 */
function ancestorHasReturnType(ancestor, options) {
    // Exit early if this ancestor is not a ReturnStatement.
    if ((ancestor === null || ancestor === void 0 ? void 0 : ancestor.type) !== experimental_utils_1.AST_NODE_TYPES.ReturnStatement) {
        return false;
    }
    ...
    while (ancestor) {
        switch (ancestor.type) {
            ...
            case experimental_utils_1.AST_NODE_TYPES.FunctionExpression:
                return (isValidFunctionExpressionReturnType(ancestor, options) ||
